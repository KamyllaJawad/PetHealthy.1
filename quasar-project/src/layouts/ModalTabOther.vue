  ...
  data() {
    return {
      ...
      columns: [ // Colunas da tabela
        { name: 'description', required: true, label: 'Descrição', align: 'left', field: 'name', sortable: true },
        { name: 'date', required: true, label: 'Data de Ocorrência', align: 'left', field: 'date', sortable: true },
      ],
